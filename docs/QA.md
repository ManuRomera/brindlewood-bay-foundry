# Verificación de la WIP 0.6.2-wip.1
...
- Dar paso a anuncios desde el salón como Guardiana y publicar únicamente el indicio y la regla del resultado 10–11. Entrar como jugadora, pulsar la macro «Generador de anuncios» y comprobar que «Generar propuesta» escribe una idea completa dentro de la misma ventana y puede sustituirla sin publicar nada en el chat.
