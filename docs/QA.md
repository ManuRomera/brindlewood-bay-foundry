# Verificación de la WIP 0.6.6-wip.1
...
- Dar paso a anuncios desde el salón como Guardiana y publicar únicamente el indicio y la regla del resultado 10–11. Ejecutar la macro «Generador de anuncios» desde el directorio como Guardiana y desde la barra rápida como jugadora: la aplicación independiente abre una idea completa y privada sin publicar nada en el chat. Se comprobó visualmente a 1280 × 720 que el texto ocupa el área central, los botones permanecen abajo y «Otra propuesta» sustituye correctamente la combinación. Una prueba de regresión comprueba además que el renderizado fija el contenido al área útil sin depender de la altura de los envoltorios de Foundry.
